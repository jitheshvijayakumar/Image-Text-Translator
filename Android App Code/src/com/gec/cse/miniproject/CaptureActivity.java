...
import com.gec.cse.miniproject.camera.ShutterButton;
import com.gec.cse.miniproject.language.LanguageCodeHelper;
import com.gec.cse.miniproject.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.add(0, EXIT, 0, "Exit").setIcon(android.R.drawable.ic_menu_info_details);
    return true;
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    case EXIT: {
    	Intent eintent = new Intent(this, CaptureActivity.class);
    	eintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    	eintent.putExtra("exit", "true");
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    if (ocrEngineModeName.equals("Both")) {
      indeterminateDialog.setMessage("Initializing OCR and Translation Engines for English to Malayalam Translation");
    } else {
      indeterminateDialog.setMessage("Initializing OCR and Translation Engines for English to Malayalam Translation");
    }
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    if (isTranslationActive) {
      ...
      translationLanguageTextView.setText("Malayalam");
  ...
  void displayProgressDialog() {
    ...
    String ocrEngineModeName = getOcrEngineModeName();
    if (ocrEngineModeName.equals("Both")) {
      indeterminateDialog.setMessage("Performing OCR Please Wait ");
    } else {
      indeterminateDialog.setMessage("Performing OCR Please Wait");
    }
    indeterminateDialog.setCancelable(false);
